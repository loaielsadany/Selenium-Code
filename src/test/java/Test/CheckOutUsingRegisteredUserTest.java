...
public class CheckOutUsingRegisteredUserTest extends TestBase {
    ...
    String email="lnvh.tshs@gmsil.com";
    ...
    public void checkCheckOutByRegisteredUser() throws InterruptedException {
        addToCartObject.openCheckOutByUser();
        checkOutObject=new CheckOutPage(driver);
        checkOutObject.checkOutByRegisteredUser(billingCountry,billingState,billingCity,billingAddress,billingPostCode,billingPhoneNo);
        Thread.sleep(1000);
    ...
    @Test (dependsOnMethods = {"checkCheckOutByRegisteredUser"})
    ...
    @Test(dependsOnMethods = {"checkInvoiceByUser"})
